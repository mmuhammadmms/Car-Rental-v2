  ...
  <div class="container" style="width:100%">
    <div class="panel panel-success">
      <div class="panel-heading">
        <h3 class="panel-title">Make car reservation with 3 steps !</h3>
      </div>
        ...
        <form name="basicform" id="basicform" method="post" action="resevpro.php" enctype="multipart/form-data">
          ...
          <div id="sf2" class="frm" style="display: none;">
            <fieldset>
              ...
              <div class="col-md-6">
              <center>Pickup Date <br />
              <input id="pdate2" type="text" class="form-control" size="8" value="" readonly >
              </center>
              </div>

              <div class="col-md-6">
              <center>Return Date <br />
              <input id="rdate2" type="text" class="form-control"  size="8" value="" readonly >
            </center>
              </div>
              ...
              <center>
                ...
                <input type="text" name="location" id="location" placeholder="Search by cars location" class="form-control" />
              ...
              <option value="Automatic">Auto</a></option>
              </select>
              </div>
  ...
  jQuery().ready(function() {
    ...
    $(".open1").click(function() {
      if (v.form()) {
        ...
        var from = $("#pdate").val().split("/");
        var until = $("#rdate").val().split("/");
        var pi = new Date(from[2], from[1] - 1, from[0]);
        var ret = new Date(until[2], until[1] - 1, until[0]);
        ...
        if (!pdate || !ptime || !rdate || !rtime)
        {
          ...
          $('#loading').html("<center><img src='img/loading.gif' width='100px' height='100px'></center>");
